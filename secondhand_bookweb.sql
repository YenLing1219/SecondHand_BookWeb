...
('cherry911219@gmail.com', '123', '410402226', 0, '2002-12-19', '資訊管理學系', '奇怪的知識增加了', 50, 0, '—Pngtree—hand-painted ink animal - penguin_4069438.png'),
...
CREATE TABLE `book_information` (
  ...
  `B_ISBN` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `B_Author` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `B_BookVersion` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `B_BookMajor` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `B_LessonName` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `B_BookPic` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `B_BookStatus` int(4) NOT NULL,
  `B_UsedStatus` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
(13, '網路概論的16堂精選課程', '97862633318', '吳燦銘', '2', '資訊管', '資料通訊與網路', '000001_1658139848.jpg', 1, '有鉛筆、螢光筆筆跡\r\n                        ', '林青峰', '無\r\n                        ', 200, '410402226', '已上架');
...
CREATE TABLE `order_information` (
  ...
  `O_LockerID` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `B_BookID` int(10) NOT NULL,
...
INSERT INTO `order_information` (`O_OrderID`, `O_OrderTime`, `O_LockerID`, `B_BookID`, `A_BuyerID`, `B_SalerID`, `O_OrderRating`, `O_OrderComments`) VALUES
(1, '2023-05-03 09:00:17', '25', 10, 'test1', '410402226', 0, NULL),
(2, '2023-05-21 06:31:27', '7', 11, '410402226', 'test1', 0, NULL);
...
--
ALTER TABLE `book_information`
  MODIFY `B_BookID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
